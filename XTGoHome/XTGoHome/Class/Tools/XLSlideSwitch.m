...
@interface XLSlideSwitch ()<UIPageViewControllerDelegate,UIPageViewControllerDataSource,XTSlideSegmentDelegate,UIScrollViewDelegate> {
    
    XTSlideSegmented *_segment;
...
- (void)buildUI {
    ...
    //添加分段选择器
    _segment = [[XTSlideSegmented alloc] init];
